...
/*
 ...
 $scope.one ="test....";
 SomeCache.put("key1","test....");
 }

 ///////////////////////////////////////

 var url="api/server/data/public/weblinks.php";
 var param=false;
 api.Query(url,param,function(data){
 console.log(data);
 });

 */
BookApp.factory('BookCache', function($cacheFactory) {
	return $cacheFactory('myData');
});

//--------------------------------------

BookApp.factory('api', function($http, BookCache) {
...
BookApp.factory('Profile', function() {
	var data = [];
	var UserInfo = {};
...
BookApp.factory('Auth', function(api, $q, $location, Profile) {
	var services = {};
	...
	services.login = function(username, password) {
		...
		var url = "api/server/data/public/auth.php";
		var param = {
			user : username,
			pass : password
		};
...
BookApp.factory('Upload', function(api, $q, $location, $rootScope) {
	var services = {};
